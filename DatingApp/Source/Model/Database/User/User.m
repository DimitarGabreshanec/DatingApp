...
//    user.matchCount = dictionary[@"matchedCount"];
    ...
    if (dictionary[@"lastActivity"]) {
        user.lastActivity = [dictionary[@"lastActivity"] doubleValue]/1000;
    } else {
        user.lastActivity = 1520000000;
    }
    
//    if (dictionary[@"professionName"] != [NSNull null]) {
//        user.professionName = [[NSString alloc] initWithString:dictionary[@"professionName"]];
//    }
//
//    if (dictionary[@"schoolName"] != [NSNull null]) {
//        user.schoolName = [[NSString alloc] initWithString:dictionary[@"schoolName"]];
//    }
