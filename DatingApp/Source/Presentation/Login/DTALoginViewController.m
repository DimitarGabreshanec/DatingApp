...
- (IBAction)actionLogin:(id)sender {
    if (!IS_HOST_REACHABLE) {
        ...
        if (!error) {
            ...
            [DTAAPI loginViaEmail:self.fieldEmail.text password:self.fieldPassword.text completion:^(NSError *error1, RKMappingResult *result) {
...
//                     [[NSUserDefaults standardUserDefaults]synchronize];
                     ...
                     [self showAlertController:@"Error" andMessage:error1 .userInfo[@"message"]];
                 }
