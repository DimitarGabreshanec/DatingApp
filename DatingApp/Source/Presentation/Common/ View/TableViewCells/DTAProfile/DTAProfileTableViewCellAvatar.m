...
@property (weak, nonatomic) IBOutlet UITextField *fieldProfession;
@property (weak, nonatomic) IBOutlet UITextField *fieldSchool;
...
- (void)prepareForReuse {
    ...
    [self.fieldProfession setFont:[UIFont fontWithName:self.fieldLastName.font.fontName size:self.fieldLastName.font.pointSize / scaleCoefficient]];
    [self.fieldSchool setFont:[UIFont fontWithName:self.fieldLastName.font.fontName size:self.fieldLastName.font.pointSize / scaleCoefficient]];
}
...
- (void)configureCell:(id)sender user:(User *)user editedAvatar:(UIImage *)avatar fromRegisterVC:(BOOL)isFromRegisterVC {
    ...
    self.fieldProfession.delegate = sender;
    self.fieldSchool.delegate = sender;
    
    self.fieldFirstName.tag = DTAProfileTextFieldTypeFirstName;
    self.fieldLastName.tag  = DTAProfileTextFieldTypeLastName;
    self.fieldProfession.tag = DTAProfileTextFieldTypeProfession;
    self.fieldSchool.tag  = DTAProfileTextFieldTypeSchool;
...
//    if (![self.fieldProfession.text length]) {
//        self.fieldProfession.text = user.professionName;
//    }
//
//    if (![self.fieldSchool.text length]) {
//        self.fieldSchool.text = user.schoolName;
//    }
    
    [self.fieldFirstName setFont:[UIFont fontWithName:self.fieldFirstName.font.fontName size:self.fieldFirstName.font.pointSize * scaleCoefficient]];
    [self.fieldLastName setFont:[UIFont fontWithName:self.fieldLastName.font.fontName size:self.fieldLastName.font.pointSize * scaleCoefficient]];
    [self.fieldProfession setFont:[UIFont fontWithName:self.fieldProfession.font.fontName size:self.fieldProfession.font.pointSize * scaleCoefficient]];
    [self.fieldSchool setFont:[UIFont fontWithName:self.fieldSchool.font.fontName size:self.fieldSchool.font.pointSize * scaleCoefficient]];
...
- (NSString *)getProfession; {
    return self.fieldProfession.text;
}

- (NSString *)getSchoolName; {
    return self.fieldSchool.text;
}
