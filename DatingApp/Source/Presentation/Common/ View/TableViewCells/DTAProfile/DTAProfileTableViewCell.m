...
- (void)configureCellWithType:(DTAProfileCellType)type inputView:(UIView *)inputView sender:(id)sender {
    ...
    switch ((DTAProfileCellType)type) {
        ...
        case DTAProfileCellTypeGoals:
            ...
            self.labelOption.text = @"Want Children";
            break;
...
//            self.labelOption.text = @"My Summary";
            ...
            self.labelOption.text = @"What is your favorite African dish?";
            self.fieldValue.placeholder = @"Type your favorite African dish";
            self.fieldValue.inputView = nil;
            break;
            ...
            self.labelOption.text = @"What is your favorite African city?";
            self.fieldValue.placeholder = @"Enter your favorite Africab city.";
            self.fieldValue.inputView = nil;
            break;
